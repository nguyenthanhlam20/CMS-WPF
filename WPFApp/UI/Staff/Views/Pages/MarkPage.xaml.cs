...
namespace WPFApp.UI.Staff.Views.Pages
{
    public class MultiParameterConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            return values.Clone(); // or new Tuple<object, object>(values[0], values[1]);
        }
    ...
    public partial class MarkPage : System.Windows.Controls.Page
    {
