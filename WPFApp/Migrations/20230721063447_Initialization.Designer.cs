...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WPFApp.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("WPFApp.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WPFApp.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("WPFApp.Models.TransactionStatus", b =>
                {
                    b.Property<int>("TransactionStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WPFApp.Models.TransactionType", b =>
                {
                    b.Property<int>("TransactionTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WPFApp.Models.Wallet", b =>
                {
                    b.Property<int>("WalletId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WPFApp.Models.Account", b =>
                {
                    b.HasOne("WPFApp.Models.Role", "Role")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("WPFApp.Models.Transaction", b =>
                {
                    b.HasOne("WPFApp.Models.Account", "OwnerNavigation")
                        .WithMany("Transactions")
                        .HasForeignKey("Owner")
                        .HasConstraintName("FK__Transacti__owner__48CFD27E");

                    b.HasOne("WPFApp.Models.TransactionStatus", "TransactionStatus")
                        .WithMany("Transactions")
                        .HasForeignKey("TransactionStatusId")
                        .HasConstraintName("FK__Transacti__trans__4AB81AF0");

                    b.HasOne("WPFApp.Models.TransactionType", "TransactionType")
                        .WithMany("Transactions")
                        .HasForeignKey("TransactionTypeId")
                        .HasConstraintName("FK__Transacti__trans__49C3F6B7");

                    b.HasOne("WPFApp.Models.Wallet", "Wallet")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("WPFApp.Models.Wallet", b =>
                {
                    b.HasOne("WPFApp.Models.Account", "EmailNavigation")
                        .WithMany("Wallets")
                        .HasForeignKey("Email")
